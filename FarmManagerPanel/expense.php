                                    ...
                                    <div class="main-card mb-3 card">
                                        <div class="card-body">
                                            ...
                                            <form class="needs-validation" method="POST" novalidate>
                                                ...
                                                <div class="position-relative form-group col-md-12"><label class="font-weight-bold" for="validationCustom07">Unit Cost</label><input name="unitcost" onkeyup="sum()" id="validationCustom07" placeholder="Enter Unit Cost" type="text" min=0 oninput="validity.valid||(value='');"  class="form-control" required>
                                                </div>
