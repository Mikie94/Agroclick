...
if(isset($_POST["submit"])){
    ...
    $query = "INSERT INTO attendance (date, userId, name, attendance, payroll) VALUES ('".$date."', '".$userId."', '".$username."', '".$attendance."', '".$payroll."')";
...
<?php
    if( $posted ) {
      if( $date &&  $userId && $username && $attendance && $payroll) 
                                    ...
                                    <div class="main-card mb-3 card">
                                        <div class="card-body">
                                            ...
                                            <form class="needs-validation" method="POST" novalidate>
                                                ...
                                                <div class="position-relative form-group col-md-12 "><label class="font-weight-bold" for="validationCustom01">User Id</label><input name="userid" id="validationCustom01" placeholder="Enter User Id" type="number" class="form-control" required>
                                                </div>
                                                <?php
                                                    ...
                                                    <div class="position-relative form-group col-md-12 "><label class="font-weight-bold" for="validationCustom09">Name</label>
                                                ...
                                                <div class="position-relative form-group col-md-12"><label class="font-weight-bold" for="validationCustom06">Attendance</label><br>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" id="customRadioInline1" name="customRadioInline1" class="custom-control-input" value="Present">
                                                        <label class="custom-control-label" for="customRadioInline1">Present</label>
                                                    </div>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" id="customRadioInline2" name="customRadioInline1" class="custom-control-input" value="Absent">
                                                ...
                                                <div class="position-relative form-group col-md-12"><label class="font-weight-bold" for="validationCustom07">Payroll</label><br>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" id="payroll" name="payroll" class="custom-control-input" value="500RWF">
                                                        <label class="custom-control-label" for="payroll">500RWF</label>
                                                    </div>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" id="payroll2" name="payroll" class="custom-control-input" value="1000RWF">
                                                        <label class="custom-control-label" for="payroll2">1000RWF</label>
                                                    </div>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" id="payroll3" name="payroll" class="custom-control-input" value="1500RWF">
