...
if(isset($_POST["submit"])){
    ...
    $query = "INSERT INTO cropscouting (date, field, details, assign, duedate) VALUES ('".$date."', '".$field."', '".$details."', '".$assign."', '".$duedate."')";
...
<?php
    if( $posted ) {
      if( $date &&  $field && $details && $assign && $duedate) 
                                    ...
                                    <div class="main-card mb-3 card">
                                        <div class="card-body">
                                            ...
                                            <form class="needs-validation" method="POST" novalidate>
                                                ...
                                                <!-- <div class="position-relative form-group col-md-12"><label class="font-weight-bold" for="validationCustom06">Assign</label><input name="assign" id="validationCustom06" placeholder="Enter Assign" type="text" class="form-control" required>
                                                </div> -->
