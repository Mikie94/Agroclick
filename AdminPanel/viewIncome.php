                ...
                <div class="app-main__inner">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="row ">
                                <div class="col-12 col-md-12 col-lg-12 ">
                                    <form class="card card-sm" method="POST" action="exportIncome.php">
                                        <div class="card-body row no-gutters align-items-center ">
                                            <div class="col-auto ">
                                                <i class="fas fa-search h4 text-body "></i>
                                            </div>
                            ...
                            <?php
                                         if(isset($_POST['search'])){
                                            ...
                                            $query1 = "SELECT * FROM  income WHERE date='$id'";
                                    ?>
                                        ...
                                        <table class="mb-0 table table-bordered">
                                            ...
                                            <?php
                                                 ...
                                                 <tr class="text-center">
                                                    ...
                                                    <td><?php echo $roww["salecenter"] ?></td>
                                                    <td><?php echo $roww["details"] ?></td>
                                                    <td><?php echo $roww["quantity"] ?></td>
                                                    <td><?php echo $roww["unitsale"] ?></td>
                                                    <td><?php echo $roww["totalsale"] ?></td>
                                                    <td> <a href="updateIncome.php?id=<?php echo $roww['id'] ?>" class="btn btn-warning btn-sm ">Edit</a> &nbsp; &nbsp;<a href="deleteIncome.php?id=<?php echo $roww['id'] ?>" class="btn btn-danger btn-sm ">Delete</a></td>
                                                </tr>
                                                <?php 
                                                    }
                                                }
                                    ...
                                    <table class="mb-0 table table-bordered">
                                        ...
                                        ?>
                                            <tr class="text-center">
                                                ...
                                                <td><?php echo $row["salecenter"] ?></td>
                                                <td><?php echo $row["details"] ?></td>
                                                <td><?php echo $row["quantity"] ?></td>
                                                <td><?php echo $row["unitsale"] ?></td>
                                                <td><?php echo $row["totalsale"] ?></td>
                                                <td> <a href="updateIncome.php?id=<?php echo $row['id'] ?>" class="btn btn-warning btn-sm ">Edit</a> &nbsp; &nbsp;<a href="deleteIncome.php?id=<?php echo $row['id'] ?>" class="btn btn-danger btn-sm ">Delete</a></td>
                                            </tr>
                                            <?php 
                                                }
                                            }
